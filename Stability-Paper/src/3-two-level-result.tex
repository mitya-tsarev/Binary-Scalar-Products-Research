...
%    \st{The statement is trivial on the plane} \textcolor{red}{You mean, it coincides with the original bound?} \textcolor{olive}{ they coincide for $d=2,3$, yes, though I meant this: The only $2$-level polytopes on the plane are triangles and parallelograms, thus the statement is trivial for $d=2$ and we will further assume $d > 2$. Replaced:}\st{, so we assume $d > 2$}. \textcolor{cyan}{
